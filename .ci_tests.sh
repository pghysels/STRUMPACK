...
then
        ...
        OMP_NUM_THREADS=1 mpirun -n 19  ./test_structure_reuse_mpi $DATA_FOLDER/pde900.mtx --sp_compression HSS --sp_matching 0 --hss_leaf_size 4 --hss_rel_tol 1e-3 --hss_abs_tol 1e-10 --sp_compression_min_sep_size 25
        OMP_NUM_THREADS=1 mpirun -n 19  ./test_structure_reuse_mpi $DATA_FOLDER/pde900.mtx --sp_compression HSS --sp_matching 2 --hss_leaf_size 4 --hss_rel_tol 1e-3 --hss_abs_tol 1e-10 --sp_compression_min_sep_size 25
        OMP_NUM_THREADS=1 mpirun -n 19  ./test_structure_reuse_mpi $DATA_FOLDER/pde900.mtx --sp_compression HSS --sp_matching 3 --hss_leaf_size 4 --hss_rel_tol 1e-3 --hss_abs_tol 1e-10 --sp_compression_min_sep_size 25
        OMP_NUM_THREADS=1 mpirun -n 19  ./test_structure_reuse_mpi $DATA_FOLDER/pde900.mtx --sp_compression HSS --sp_matching 4 --hss_leaf_size 4 --hss_rel_tol 1e-3 --hss_abs_tol 1e-10 --sp_compression_min_sep_size 25
        OMP_NUM_THREADS=1 mpirun -n 19  ./test_structure_reuse_mpi $DATA_FOLDER/pde900.mtx --sp_compression HSS --sp_matching 5 --hss_leaf_size 4 --hss_rel_tol 1e-3 --hss_abs_tol 1e-10 --sp_compression_min_sep_size 25
fi
