...
EXEC="/gpfs/alpine/scratch/liuyangz/csc289/STRUMPACK_master/build/examples/KernelRegressionMPI"
if [ ! -f ${EXEC} ]; then
...
--hss_ann_iterations 5 \
--hss_scratch_folder ${FOLDER} \
--hss_verbose \
--hodlr_rel_tol ${RTOL} \
--hodlr_geo 0 \
--hodlr_knn_hodlrbf ${k_ann} \
--hodlr_lr_leaf ${lr_leaf} | tee $DATA0/log_run_1e-2_exact_nn.out
