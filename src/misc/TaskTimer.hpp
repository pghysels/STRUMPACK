  ...
  enum class TaskType : int
    {
     ...
     HSS_SEQHQRINTERPOL, EXTRACT_2D, EXTRACT_SEP_2D, GET_SUBMATRIX_2D,
     HSS_EXTRACT_SCHUR, GET_SUBMATRIX, HSS_PARTIALLY_FACTOR, F11INV_MULT,
     HSS_COMPUTE_SCHUR, HSS_FACTOR, FORWARD_SOLVE, LOOK_LEFT, SOLVE_LOWER,
     SOLVE_LOWER_ROOT, BACKWARD_SOLVE, SOLVE_UPPER, LOOK_RIGHT,
     DISTMAT_EXTRACT_ROWS, DISTMAT_EXTRACT_COLS, DISTMAT_EXTRACT, QR,
