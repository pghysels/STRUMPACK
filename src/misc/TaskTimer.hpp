...
#define GET_TIME_NOW() timer::now()
  ...
  enum class TaskType : int {
    RANDOM_SAMPLING=0, RANDOM_GENERATE, FRONT_MULTIPLY_2D, UUTXR, F22_MULT,
      ...
      SKINNY_EXTEND_ADD_MPIMPI, SKINNY_EXTEND_ADD_MPI1, HSS_COMPRESS, HSS_COMPRESS_22,
      EXTRACT_GRAPH, CONSTRUCT_PTREE, CONSTRUCT_HIERARCHY, NEIGHBOR_SEARCH, LRBF_COMPRESS,
      CONSTRUCT_INIT, HSS_PARHQRINTERPOL, HSS_SEQHQRINTERPOL, EXTRACT_2D,
