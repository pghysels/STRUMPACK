...
*>
*  =====================================================================
      SUBROUTINE ZGEQRFMOD( M, N, A, LDA, TAU, WORK, LWORK,
     $     INFO, DEPTH )
*
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZGEQR2MOD, ZLARFBMOD, ZLARFTMOD
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*           A(i:m,i:i+ib-1)
*
            CALL ZGEQR2MOD( M-I+1, IB, A( I, I ), LDA, TAU( I ), WORK,
     $                   IINFO, DEPTH )
            IF( I+IB.LE.N ) THEN
*
...
*
               CALL ZLARFTMOD( 'Forward', 'Columnwise', M-I+1, IB,
     $              A( I, I ), LDA, TAU( I ), WORK,
     $              LDWORK, DEPTH )
*
*              Apply H**H to A(i:m,i+ib:n) from the left
*
               CALL ZLARFBMOD( 'Left', 'Conjugate transpose', 'Forward',
...
*
      IF( I.LE.K )
     $   CALL ZGEQR2MOD( M-I+1, N-I+1, A( I, I ), LDA, TAU( I ), WORK,
     $                IINFO, DEPTH )
*
      WORK( 1 ) = IWS
      RETURN
