      SUBROUTINE ZLARFBMOD( SIDE, TRANS, DIRECT, STOREV, M, N, K, 
     $     V, LDV, T, LDT, C, LDC, WORK, LDWORK, DEPTH )
*
...
*     .. External Subroutines ..
      EXTERNAL           ZCOPY, ZGEMM_OMP_TASK, ZLACGV, ZTRMM_OMP_TASK
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DCONJG
*     ..
...
*              W := W * V1
*
               CALL ZTRMM_OMP_TASK( 'Right', 'Lower', 'No transpose',
     $              'Unit', N,
...
*                 W := W + C2**H * V2
*
                  CALL ZGEMM_OMP_TASK( 'Conjugate transpose',
     $                 'No transpose', N,
...
*              W := W * T**H  or  W * T
*
               CALL ZTRMM_OMP_TASK( 'Right', 'Upper', TRANST,
     $              'Non-unit', N, K,
...
*                 C2 := C2 - V2 * W**H
*
                  CALL ZGEMM_OMP_TASK( 'No transpose',
     $                 'Conjugate transpose',
...
*              W := W * V1**H
*
               CALL ZTRMM_OMP_TASK( 'Right', 'Lower',
     $              'Conjugate transpose',
...
*                 W := W + C2 * V2
*
                  CALL ZGEMM_OMP_TASK( 'No transpose', 'No transpose',
     $                 M, K, N-K,
...
*              W := W * T  or  W * T**H
*
               CALL ZTRMM_OMP_TASK( 'Right', 'Upper', TRANS,
     $              'Non-unit', M, K,
     $              ONE, T, LDT, WORK, LDWORK, DEPTH )
*
*              C := C - W * V**H
...
*              W := W * V2
*
               CALL ZTRMM_OMP_TASK( 'Right', 'Upper',
     $              'No transpose', 'Unit', N,
...
*              W := W * T**H  or  W * T
*
               CALL ZTRMM_OMP_TASK( 'Right', 'Lower', TRANST,
     $              'Non-unit', N, K,
     $              ONE, T, LDT, WORK, LDWORK, DEPTH )
*
*              C := C - V * W**H
...
*              W := W * T  or  W * T**H
*
               CALL ZTRMM_OMP_TASK( 'Right', 'Lower', TRANS,
     $              'Non-unit', M, K,
     $              ONE, T, LDT, WORK, LDWORK, DEPTH )
*
*              C := C - W * V**H
