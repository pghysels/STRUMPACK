...
*>
*  =====================================================================
      SUBROUTINE CGEQRFMOD( M, N, A, LDA, TAU, WORK, LWORK,
     $     INFO, DEPTH )
*
...
*     .. External Subroutines ..
      EXTERNAL           CGEQR2MOD, CLARFBMOD, CLARFTMOD, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*           A(i:m,i:i+ib-1)
*
            CALL CGEQR2MOD( M-I+1, IB, A( I, I ), LDA, TAU( I ), WORK,
     $           IINFO, DEPTH )
            IF( I+IB.LE.N ) THEN
*
...
*
               CALL CLARFTMOD( 'Forward', 'Columnwise', M-I+1, IB,
     $              A( I, I ), LDA, TAU( I ), WORK, LDWORK, DEPTH )
*
*              Apply H**H to A(i:m,i+ib:n) from the left
*
               CALL CLARFBMOD( 'Left', 'Conjugate transpose', 'Forward',
     $                      'Columnwise', M-I+1, N-I-IB+1, IB,
     $                      A( I, I ), LDA, WORK, LDWORK, A( I, I+IB ),
     $                      LDA, WORK( IB+1 ), LDWORK, DEPTH )
            END IF
   10    CONTINUE
      ELSE
         I = 1
...
*
      IF( I.LE.K )
     $   CALL CGEQR2MOD( M-I+1, N-I+1, A( I, I ), LDA, TAU( I ), WORK,
     $                IINFO, DEPTH )
*
      WORK( 1 ) = IWS
      RETURN
