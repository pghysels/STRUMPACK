...
*
*  =====================================================================
      SUBROUTINE DGETRFMOD( M, N, A, LDA, IPIV, INFO, DEPTH )
*
...
*     .. External Subroutines ..
      EXTERNAL           DGEMM_OMP_TASK, DGETF2MOD, DLASWP_OMP_TASK, 
     $     DTRSM_OMP_TASK, XERBLA
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
      EXTERNAL           ILAENV
...
*        Use unblocked code.
*
         CALL DGETF2MOD( M, N, A, LDA, IPIV, INFO, DEPTH )
      ELSE
*
*        Use blocked code.
*
...
*           singularity.
*
            CALL DGETF2MOD( M-J+1, JB, A( J, J ), LDA, 
     $           IPIV( J ), IINFO, DEPTH )
*
...
*
            CALL DLASWP_OMP_TASK( J-1, A, LDA, J, J+JB-1, IPIV,
     $           1, DEPTH )
*
            IF( J+JB.LE.N ) THEN
*
...
*
               CALL DLASWP_OMP_TASK( N-J-JB+1, A( 1, J+JB ), LDA, J,
     $              J+JB-1, IPIV, 1, DEPTH )
*     
*     Compute block row of U.
*     
               CALL DTRSM_OMP_TASK( 'Left', 'Lower', 'No transpose',
