...
*
*  =====================================================================
      SUBROUTINE SGETRFMOD( M, N, A, LDA, IPIV, INFO, DEPTH )
*
...
*     .. External Subroutines ..
      EXTERNAL           SGEMM_OMP_TASK, SGETF2MOD, SLASWP_OMP_TASK,
     $     STRSM_OMP_TASK, XERBLA
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
      EXTERNAL           ILAENV
...
*        Use unblocked code.
*
         CALL SGETF2MOD( M, N, A, LDA, IPIV, INFO, DEPTH )
      ELSE
*
*        Use blocked code.
*
...
*           singularity.
*
            CALL SGETF2MOD( M-J+1, JB, A( J, J ), LDA, 
     $           IPIV( J ), IINFO, DEPTH )
*
...
*
            CALL SLASWP_OMP_TASK( J-1, A, LDA, J, J+JB-1, IPIV,
     $           1, DEPTH )
*
            IF( J+JB.LE.N ) THEN
*
...
*
               CALL SLASWP_OMP_TASK( N-J-JB+1, A( 1, J+JB ), LDA, J,
     $                       J+JB-1, IPIV, 1, DEPTH )
*
*              Compute block row of U.
*
               CALL STRSM_OMP_TASK( 'Left', 'Lower', 'No transpose',
