...
namespace strumpack {
  namespace HSS {
    ...
    protected:
      ...
      virtual Inertia readInertiaOffBlockDiag(const DenseM_t D, const std::vector<int>& IPIV) const {};
      virtual Inertia inertia_recursive(WorkInertia<scalar_t>& w, bool isroot, int depth) const {} ;
