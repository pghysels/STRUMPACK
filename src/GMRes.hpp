...
namespace strumpack {
   ...
   */
  template <typename scalar_t,typename integer_t> typename RealType<scalar_t>::value_type GMRes
  (CompressedSparseMatrix<scalar_t,integer_t>* A, std::function<void(scalar_t*)> preconditioner,
