...
*
*  =====================================================================
      SUBROUTINE MYDLAQP2( M, N, OFFSET, A, LDA, JPVT, TAU, VN1, VN2,
     $                   WORK, KB, TOL )
*
...
*     .. Local Scalars ..
      ...
      DOUBLE PRECISION   AII, TEMP, TEMP2, TOL3Z, TOL
*     ..
...
*
   ...
   10    CONTINUE
*
         IF( DNRM2( N-I+1, VN1( I ), 1 ) <= TOL ) THEN
c$$$  WRITE(*,*) RK, DNRM2( N-K+1, VN1( K ), 1 )
            GO TO 99
         ENDIF
