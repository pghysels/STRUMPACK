...
*>
*  =====================================================================
      SUBROUTINE SGEQRFMOD( M, N, A, LDA, TAU, WORK, LWORK,
     $     INFO, DEPTH )
*
...
*     .. External Subroutines ..
      EXTERNAL           SGEQR2MOD, SLARFBMOD, SLARFTMOD, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*           A(i:m,i:i+ib-1)
*
            CALL SGEQR2MOD( M-I+1, IB, A( I, I ), LDA, TAU( I ), WORK,
     $                   IINFO, DEPTH )
            IF( I+IB.LE.N ) THEN
*
...
*
               CALL SLARFTMOD( 'Forward', 'Columnwise', M-I+1, IB,
     $              A( I, I ), LDA, TAU( I ), WORK,
     $              LDWORK, DEPTH )
*
*              Apply H**T to A(i:m,i+ib:n) from the left
*
               CALL SLARFBMOD( 'Left', 'Transpose', 'Forward',
...
*
      IF( I.LE.K )
     $   CALL SGEQR2MOD( M-I+1, N-I+1, A( I, I ), LDA, TAU( I ), WORK,
     $                IINFO, DEPTH )
*
      WORK( 1 ) = IWS
      RETURN
