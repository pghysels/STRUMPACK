...
namespace strumpack {
  ...
  namespace HBS {
    ...
    HBSOptions<scalar_t>::set_from_command_line
    ...
    template<typename scalar_t> void
    HBSOptions<scalar_t>::describe_options() const {
#if defined(STRUMPACK_USE_GETOPT)
      if (!mpi_root()) return;
    ...
    template class HBSOptions<float>;
    template class HBSOptions<double>;
    template class HBSOptions<std::complex<float>>;
    template class HBSOptions<std::complex<double>>;
