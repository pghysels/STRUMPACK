...
#include "FrontalMatrixGPUBLR.hpp"
...
namespace strumpack {
  ...
  FrontalMatrixGPUBLR<scalar_t,integer_t>::FrontalMatrixGPUBLR
  ...
  FrontalMatrixGPUBLR<scalar_t,integer_t>::release_work_memory() {
    F22_.clear();
    host_Schur_.release();
  }
...
#if defined(STRUMPACK_USE_MPI)
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::extend_add_copy_to_buffers
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::extend_add_to_dense
...
#pragma omp taskloop default(shared) grainsize(64)      \
  ...
  template<typename scalar_t, typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::front_assembly
  ...
  template<typename scalar_t, typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::factor_small_fronts
  ...
  template<typename scalar_t, typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::factor_large_fronts
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::split_smaller
...
#pragma omp single
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::multifrontal_factorization
  (const SpMat_t& A, const SPOptions<scalar_t>& opts,
   int etree_level, int task_depth) {
#if defined(STRUMPACK_USE_MAGMA)
    if (opts.replace_tiny_pivots())
  ...
  FrontalMatrixGPUBLR<scalar_t,integer_t>::move_to_gpu() const {
    const int lvls = this->levels();
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::multifrontal_solve
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::rhs_to_contig
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::rhs_from_contig
  ...
  template<typename scalar_t, typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::assemble_rhs
  ...
  template<typename scalar_t, typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::fwd_small_fronts
  ...
  template<typename scalar_t, typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::fwd_large_fronts
...
#if 0
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::forward_multifrontal_solve
...
#pragma omp single nowait
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::fwd_solve_gpu
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::fwd_solve_phase2
  ...
  template<typename scalar_t, typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::extract_rhs
  ...
  template<typename scalar_t, typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::bwd_small_fronts
  (int nrhs, LInfo_t& L, gpu::FrontData<scalar_t>* fdata,
  ...
  template<typename scalar_t, typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::bwd_large_fronts
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::backward_multifrontal_solve
...
#pragma omp single nowait
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::bwd_solve_gpu
  ...
  template<typename scalar_t,typename integer_t> void
  FrontalMatrixGPUBLR<scalar_t,integer_t>::bwd_solve_phase1
  ...
  template class FrontalMatrixGPUBLR<float,int>;
  template class FrontalMatrixGPUBLR<double,int>;
  template class FrontalMatrixGPUBLR<std::complex<float>,int>;
  template class FrontalMatrixGPUBLR<std::complex<double>,int>;

  template class FrontalMatrixGPUBLR<float,long int>;
  template class FrontalMatrixGPUBLR<double,long int>;
  template class FrontalMatrixGPUBLR<std::complex<float>,long int>;
  template class FrontalMatrixGPUBLR<std::complex<double>,long int>;

  template class FrontalMatrixGPUBLR<float,long long int>;
  template class FrontalMatrixGPUBLR<double,long long int>;
  template class FrontalMatrixGPUBLR<std::complex<float>,long long int>;
  template class FrontalMatrixGPUBLR<std::complex<double>,long long int>;
