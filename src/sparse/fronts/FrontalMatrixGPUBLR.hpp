 ...
 *
 */
#ifndef FRONTAL_MATRIX_GPU_BLR_HPP
#define FRONTAL_MATRIX_GPU_BLR_HPP
...
namespace strumpack {
  ...
  template<typename scalar_t,typename integer_t> class FrontalMatrixGPUBLR
    : public FrontalMatrix<scalar_t,integer_t> {
    using F_t = FrontalMatrix<scalar_t,integer_t>;
    using FG_t = FrontalMatrixGPU<scalar_t,integer_t>;
    using FGB_t = FrontalMatrixGPU<scalar_t,integer_t>;
  ...
  public:
    FrontalMatrixGPUBLR(integer_t sep, integer_t sep_begin, integer_t sep_end,
    ...
    std::string type() const override { return "FrontalMatrixGPUBLR"; }
  ...
  private:
    ...
    FrontalMatrixGPUBLR(const FrontalMatrixGPU&) = delete;
    FrontalMatrixGPUBLR& operator=(FrontalMatrixGPU const&) = delete;
...
#endif // FRONTAL_MATRIX_GPU_BLR_HPP
