 ...
 *
 */
#ifndef FRONTAL_MATRIX_H2OPUS_HPP
#define FRONTAL_MATRIX_H2OPUS_HPP
...
namespace strumpack {
  ...
  template<typename scalar_t,typename integer_t> class FrontH2Opus
  ...
  public:
    FrontH2Opus(integer_t sep, integer_t sep_begin, integer_t sep_end,
    ...
    std::string type() const override { return "FrontH2Opus"; }
