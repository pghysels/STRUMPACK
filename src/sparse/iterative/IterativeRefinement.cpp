...
namespace strumpack {
  ...
  namespace iterative {
    ...
    template void IterativeRefinement
    (const SpMat<float,int>& A, const Prec<float>& M, DMat<float>& x,
     const DMat<float>& b, float rtol, float atol, int& totit, int maxit,
     bool non_zero_guess, bool verbose);
    template void IterativeRefinement
    (const SpMat<double,int>& A, const Prec<double>& M, DMat<double>& x,
     const DMat<double>& b, double rtol, double atol, int& totit, int maxit,
     bool non_zero_guess, bool verbose);
    template void IterativeRefinement
    ...
    template void IterativeRefinement
    (const SpMat<float,long int>& A, const Prec<float>& M, DMat<float>& x,
     const DMat<float>& b, float rtol, float atol, int& totit, int maxit,
     bool non_zero_guess, bool verbose);
    template void IterativeRefinement
    (const SpMat<double,long int>& A, const Prec<double>& M, DMat<double>& x,
     const DMat<double>& b, double rtol, double atol, int& totit, int maxit,
     bool non_zero_guess, bool verbose);
    template void IterativeRefinement
    ...
    template void IterativeRefinement
    (const SpMat<float,long long int>& A, const Prec<float>& M,
     DMat<float>& x, const DMat<float>& b, float rtol, float atol,
     int& totit, int maxit, bool non_zero_guess, bool verbose);
    template void IterativeRefinement
    (const SpMat<double,long long int>& A, const Prec<double>& M,
    ...
    template void IterativeRefinement
    (const DMat<float>& A, const Prec<float>& M, DMat<float>& x,
     const DMat<float>& b, float rtol, float atol, int& totit, int maxit,
     bool non_zero_guess, bool verbose);
    template void IterativeRefinement
    (const DMat<double>& A, const Prec<double>& M, DMat<double>& x,
     const DMat<double>& b, double rtol, double atol, int& totit, int maxit,
     bool non_zero_guess, bool verbose);
    template void IterativeRefinement
    (const DMat<std::complex<float>>& A, const Prec<std::complex<float>>& M,
     DMat<std::complex<float>>& x, const DMat<std::complex<float>>& b,
     float rtol, float atol, int& totit, int maxit,
     bool non_zero_guess, bool verbose);
    template void IterativeRefinement
    (const DMat<std::complex<double>>& A, const Prec<std::complex<double>>& M,
     DMat<std::complex<double>>& x, const DMat<std::complex<double>>& b,
